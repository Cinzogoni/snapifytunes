    ...
    return [
      {
        ...
        link:
          process.env.NODE_ENV === "production"
            ? `${process.env.PUBLIC_URL}/videos/MAKING 12H03 TOULIVER MASTAL.mp4`
      ...
      },
      {
        ...
        link:
          process.env.NODE_ENV === "production"
            ? `${process.env.PUBLIC_URL}/videos/ĐÀO LIỄU TOULIVER TRIPLE D.mp4`
      ...
      },
      {
        ...
        link:
          process.env.NODE_ENV === "production"
            ? `${process.env.PUBLIC_URL}/videos/BEAT TRỐNG CƠM-ATVNTG.mp4`
      ...
      },
      {
        ...
        link:
          process.env.NODE_ENV === "production"
            ? `${process.env.PUBLIC_URL}/videos/GIÀUSANG-KrissNgo.mp4`
      ...
      },
      {
        ...
        link:
          process.env.NODE_ENV === "production"
            ? `${process.env.PUBLIC_URL}/videos/QLGIƯỜNGĐIEM-MASTAL.mp4`
